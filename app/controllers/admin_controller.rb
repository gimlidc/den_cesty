...
class AdminController < ApplicationController
  ...
  def payments_download
    json = RestClient.get 'https://www.fio.cz/ib_api/rest/periods/caN5ovDtmvByjU5V6s1AnSnCHZb1KAvF590C6ALh7CcOwumCHy2Frz9796CkQH3i/2019-01-01/2019-04-27/transactions.json'
