...
class Dc < ActiveRecord::Base
  ...
  attr_accessible :name_cs, :name_en, :start_time, :description, :rules_id, :reg_price, :map_bw_price, :map_color_price, :shirt_price, :own_shirt_price, :polyester_shirt_price, :scarf_price, :limit, :diplom_path, :race_id
